...
<%@page import="com.gestion_medical.Specialite"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.gestion_medical.SpecialiteDao"%>
<%@page import="com.gestion_medical.PatienDao"%>
...
<html>
    ...
    <body>
        ...
        <%  
            ...
            ArrayList<Specialite> spspecialites = specialiteDao.getSpecialites();
        %>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
          <div class="container-fluid px-xl-5" style="padding-top: 50px;">
            <!-- content Home -->
            <center>
                <div class="col-lg-12 mb-5" style="width: 700px;">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">Prenez Rendez-Vous</h3>
                      </div>
                        
                      <div class="card-body">
                        <form class="form-horizontal" style="width: 400px;">
                            <div class="form-group row">
                            <label class="col-md-3 form-control-label">Specialite</label>
                                <div class="col-md-9 select mb-3">
                                  <select name="account" class="form-control">
                                        <c:forEach items="${spspecialites}" var="spspecialite" >  
                                            <option> ${spspecialite.getName()} </option>  
                                        </c:forEach>  
                                  </select>
                                </div>
                            </div>
